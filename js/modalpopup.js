...
var projInfo = {
  ...
  //Project Goal
  'senstaff-goal' : 'The Senstaff unites active living with technological and environmental agency. The design goal was to create an object that engaged youthful curiosity in the collection of environmental data. By designing a product that serves as both a hiking staff and a sensor for environmental pollutants, the senstaff hopes to inspire democratic collection of environmental data for local communities to leverage in the pursuit of sustainable development.',
...
function populateModal(elt) {
  ...
  modal.find('.img').css('background-image', img);
	modal.find('.imgTxt').html(imgTxt);
	modal.find('.goal').html(goal);
